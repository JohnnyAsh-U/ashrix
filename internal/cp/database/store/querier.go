...
type Querier interface {
	...
	ListPoliciesByAppResource(ctx context.Context, arg ListPoliciesByAppResourceParams) ([]ListPoliciesByAppResourceRow, error)
	ListPoliciesByOrg(ctx context.Context, orgID uuid.UUID) ([]ListPoliciesByOrgRow, error)
